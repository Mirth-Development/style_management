...
function build_head(title: string): string {
    ...
    const scripted_builder_links =
        [
            ...
            `       <script type="module" src="../scripts/transpiled_scripts/builders/blank_html.js"></script>`,
            `       <script type="module" src="../scripts/transpiled_scripts/builders/testing_html.js"></script>`,
        ].join("\n");
