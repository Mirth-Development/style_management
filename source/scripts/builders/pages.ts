...
function build_body_testing(title: string): string {
    ...
    return [
        ...
        ``,
        `            <!-- Button Test -->`,
        `            <div id="${MENU.menu_button_navigation.without_selector}" class="${FORMS.form_static_column_center.without_selector}">`,
        `                <span class="${ICONS.icon_menu.without_selector}">browse</span>`,
        `                <label for="${MENU.menu_button_navigation.without_selector}">NAV</label>`,
        `            </div>`,
        ``,
        `            <div id="${MENU.menu_button_change.without_selector}" class="${FORMS.form_static_column_center.without_selector}">`,
        `                <span class="${ICONS.icon_menu.without_selector}">edit_square</span>`,
        `                <label for="${MENU.menu_button_change.without_selector}">MOD</label>`,
        `            </div>`,
        ``,
        `            <div id="${MENU.menu_button_settings.without_selector}" class="${FORMS.form_static_column_center.without_selector}">`,
        `                <span class="${ICONS.icon_menu.without_selector}">settings</span>`,
        `                <label for="${MENU.menu_button_settings.without_selector}">CFG</label>`,
        `            </div>`,
        ``,
        `       </div>`,
        ``,
