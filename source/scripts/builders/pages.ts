...
function build_body_testing(title: string): string {
    ...
    return [
        ...
        `            </div>`,
        ``,
        `            <div id="${MENU.menu_button_edit.without_selector}" class="${FORMS.form_static_column_center.without_selector}">`,
        `                <span class="${ICONS.icon_menu.without_selector}">edit_square</span>`,
        `                <label for="${MENU.menu_button_edit.without_selector}">MOD</label>`,
        `            </div>`,
        ``,
