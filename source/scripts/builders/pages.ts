...
function build_body_testing(title: string): string {
    ...
    return [
        `   <body class="${FORMS.form_static_column_center.without_selector} ${MARGINS.margin_2.without_selector}">`,
        ``,
        `       <div id="${IDS.menu.without_selector}" class="${FORMS.form_fixed_column_center.without_selector}">`,
        ``,
        `            <!-- Button Test -->`,
        `            <div id="${IDS.navigation_button.without_selector}">`,
        `                <span class="${ICONS.icon_general.without_selector}">browse</span>`,
        `                <label for="${IDS.navigation_button.without_selector}">Navigation</label>`,
        `            </div>`,
        ``,
        `            <div id="${IDS.edit_button.without_selector}">`,
        `                <span class="${ICONS.icon_general.without_selector}">edit</span>`,
        `                <label for="${IDS.edit_button.without_selector}">Edit</label>`,
        `            </div>`,
        ``,
        `            <div id="${IDS.settings_button.without_selector}">`,
        `                <span class="${ICONS.icon_general.without_selector}">settings</span>`,
        `                <label for="${IDS.settings_button.without_selector}">Settings</label>`,
        `            </div>`,
        ``,
        `       </div>`,
        ``,
